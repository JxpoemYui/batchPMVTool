...
function pmv (ta, tr, vel, rh, met, clo, wme = 0) {
    /**
...
function pmvFastTa(ta){
    return pmv(ta, 35, 0.1, 50, 1, 1.1, 0);
}
function pmvFastTr(tr){
    return pmv(15, tr, 0.1, 50, 1, 1.1, 0);
}
...
lines.forEach((line) => {
    console.log(pmvFastTr(Number(line)));
});